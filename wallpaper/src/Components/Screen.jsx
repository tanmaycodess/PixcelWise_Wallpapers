...
export const HeroParallax = ({ products }) => {
    ...
    const springConfig = { stiffness: 300, damping: 30, bounce: 0.5 };
    ...
    return (
        <div
            ref={ref}
            className={
                "h-[300vh] py-40 overflow-hidden antialiased relative flex flex-col " +
    ...
    return (
        <div className={styles.headerContainer}>
            <h1 className={styles.headerTitle}>
                The Ultimate <br /> PixcelWise Wallpapers
            </h1>
